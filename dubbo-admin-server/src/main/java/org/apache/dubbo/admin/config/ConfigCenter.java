...
public class ConfigCenter {
    ...
    public void init() throws Exception {
        ...
        zkClient.setData().forPath("/dubbo/config/dubbo/dubbo.properties", ("dubbo.registry.address=zookeeper://" + zkIp + "\n" +
                "dubbo.metadata-report.address=zookeeper://"+zkIp).getBytes());
    }
    //zjq
